-- Create analytics events table (optional RLS can be added later)
...
-- Ensure tables exist with consistent privileges
GRANT INSERT, SELECT, UPDATE, DELETE ON analytics_events TO authenticated;
GRANT INSERT, SELECT, UPDATE, DELETE ON analytics_page_views TO authenticated;
